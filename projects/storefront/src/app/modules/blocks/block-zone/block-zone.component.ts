        ...
        this.tabs = [
            {
                ...
                products$: this.shopApi.getFeaturedProducts(this.category?.slug || null, 6),
            },
            {
                name: 'TEXT_TAB_BESTSELLERS',
                products$: this.shopApi.getPopularProducts(this.category?.slug || null, 6),
            },
            {
                name: 'TEXT_TAB_TOP_RATED',
                products$: this.shopApi.getTopRatedProducts(this.category?.slug || null, 6),
            },
        ];
